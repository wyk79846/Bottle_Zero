...
def main():
    parser = argparse.ArgumentParser(description="BottleZero模型交互对话")
    parser.add_argument('--model_path', default='/apdcephfs_qy4/share_302593112/huaibingxie/BottleZero/out_sft/exp_3/h768_l12_bs128_lr0.001/global_step_5930/sft_768.pth', type=str, help="模型权重路径（.pth文件）")
    ...
    model = BottleZeroForCausalLM(BottleZeroConfig(
    ...
    while True:
        ...
        # 生成回复
        print('🧽 BottleZero: ', end='', flush=True)
        with torch.no_grad():
